// Package imports
import { Flex, Spacer, VStack, HStack, Heading } from "@chakra-ui/react";
  ...
  const ratings = [
    {
      ...
      image: randomUser1,
      review:
        "Splendid decor and atmosphere, and commendable attitudes shown by staff",
    },
    {
      name: "Jon",
      stars: 4,
    ...
    },
    {
      ...
      image: randomUser3,
      review:
        "I had a wonderful dinner at Little Lemon, would definitely recommend",
    },
    {
      name: "Peter",
      stars: 3,
